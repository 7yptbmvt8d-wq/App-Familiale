...
const members = [
  ...
  { id: 'm-lea', name: 'Léa', role: 'member', relation: 'Fille', birthDate: '2012-05-21', color: '#C99A4E', initials: 'Lé' },
  { id: 'm-tom', name: 'Tom', role: 'member', relation: 'Fils', birthDate: '2015-01-08', color: '#7E8A6A', initials: 'To' },
  { id: 'm-jeanne', name: 'Jeanne', role: 'member', relation: 'Grand-mère', birthDate: '1955-11-30', color: '#B98A57', initials: 'Je' },
  { id: 'm-robert', name: 'Robert', role: 'member', relation: 'Grand-père', birthDate: '1953-06-17', color: '#8A6A4F', initials: 'Ro' },
  { id: 'm-sofia', name: 'Sofia', role: 'member', relation: 'Cousine', birthDate: '1996-02-14', color: '#C4623F', initials: 'So' },
  { id: 'm-hugo', name: 'Hugo', role: 'member', relation: 'Oncle', birthDate: '1989-07-25', color: '#A24C32', initials: 'Hu' },
];
...
const posts = [
  ...
  { id: 'p-recit', authorId: 'm-jeanne', type: 'text', text: "Votre grand-père a construit la cabane du jardin l'été 1979, avec trois planches et beaucoup d'entêtement.", tilt: 0, createdAt: now - D, memoryDate: new Date('1979-07-15').getTime(), favorites: ['m-helene', 'm-hugo'], comments: [] },
...
const inviteCodes = [
  { code: 'LACROIX-2026', role: 'member', label: 'Proche' },
  { code: 'LACROIX-7788', role: 'admin', label: 'Responsable' },
];
...
export async function seed() {
  ...
  console.log(`Seed OK : ${members.length} membres, ${posts.length} souvenirs, ${inviteCodes.length} codes.`);
}
